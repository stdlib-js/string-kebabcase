...
```javascript
import kebabcase from 'https://cdn.jsdelivr.net/gh/stdlib-js/string-kebabcase@v0.0.5-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/string-kebabcase/actions/workflows/test.yml/badge.svg?branch=v0.0.5
[test-url]: https://github.com/stdlib-js/string-kebabcase/actions/workflows/test.yml?query=branch:v0.0.5
