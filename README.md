...
```javascript
kebabcase = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/string-kebabcase@v0.0.4-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/string-kebabcase@v0.0.4-umd/browser.js"></script>
```
